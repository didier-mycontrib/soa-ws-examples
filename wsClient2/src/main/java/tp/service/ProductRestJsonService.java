...
//NB: bien que les annotations JAX-RS placées sur l'interface (JAX-RS2 , JEE7) puissent être héritées
//par la classe d'implémentation , il est préconsiné (à court/moyen terme) de replacer
//celles-ci sur la classe d'implémentation (pour une compatibilité avec JEE6).