...
public class ObjectFactory {
    ...
    private final static QName _UploadFile_QNAME = new QName("http://service.tp/", "uploadFile");
    private final static QName _UploadFileResponse_QNAME = new QName("http://service.tp/", "uploadFileResponse");
    ...
    /**
     * Create an instance of {@link FileToUpload }
     * 
     */
    public FileToUpload createFileToUpload() {
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.tp/", name = "uploadFile")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.tp/", name = "uploadFileResponse")
